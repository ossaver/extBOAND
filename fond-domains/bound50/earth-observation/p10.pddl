(define (problem p10)
  ...
  (:init
    ...
    (:utility
      (= (not (is-target p12)) 7)
      (= (not (is-target p13)) 7)
      (= (not (is-target p14)) 28)
      (= (not (is-target p15)) 15)
      (= (not (is-target p17)) 17)
      (= (not (is-target p21)) 24)
      (= (not (is-target p22)) 19)
      (= (not (is-target p24)) 8)
      (= (not (is-target p25)) 45)
      (= (not (is-target p26)) 24)
      (= (not (is-target p27)) 29)
      (= (not (is-target p32)) 40)
      (= (not (is-target p33)) 42)
      (= (not (is-target p34)) 21)
      (= (not (is-target p35)) 25)
      (= (not (is-target p37)) 2)
      (= (not (is-target p41)) 3)
      (= (not (is-target p42)) 36)
      (= (not (is-target p43)) 33)
      (= (not (is-target p44)) 4)
      (= (not (is-target p45)) 23)
      (= (not (is-target p46)) 4)
      (= (not (is-target p47)) 30)
  )
