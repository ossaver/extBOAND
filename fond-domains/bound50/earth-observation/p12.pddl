(define (problem p12)
  ...
  (:init
    ...
    (:utility
      (= (not (is-target p22)) 20)
      (= (not (is-target p23)) 19)
      (= (not (is-target p31)) 24)
      (= (not (is-target p41)) 29)
      (= (not (is-target p42)) 25)
      (= (not (is-target p43)) 39)
      (= (not (is-target p44)) 11)
      (= (not (is-target p45)) 46)
      (= (not (is-target p51)) 27)
      (= (not (is-target p54)) 38)
      (= (not (is-target p55)) 32)
  )
