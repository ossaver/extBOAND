...
(:functions
  ...
  (:action complete-boarding
    ...
    :effect (and (oneof (and) (and (not (boarding ?p ?a)) (in ?p ?a) (not-boarding ?p))) (increase (total-cost) 1))
  )
  ...
  (:action complete-debarking
    ...
    :effect (and (oneof (and) (and (not (debarking ?p ?a)) (at-person ?p ?c) (not-debarking ?p))) (increase (total-cost) 1))
  )
  (:action start-flying
  ...
  (:action complete-flying
    ...
    :effect (and (oneof (and) (and (not (flying ?a ?c2)) (at-aircraft ?a ?c2) (not (fuel-level ?a ?l1)) (fuel-level ?a ?l2))) (increase (total-cost) 1))
  )
  ...
  (:action complete-zooming
   ...
   :effect (and (oneof (and) (and (not (zooming ?a ?c2)) (at-aircraft ?a ?c2) (not (fuel-level ?a ?l1)) (fuel-level ?a ?l3))) (increase (total-cost) 1))
  )
  ...
  (:action complete-refuling
    ...
    :effect (and (oneof (and) (and (not (refueling ?a)) (not-refueling ?a) (fuel-level ?a ?l1) (not (fuel-level ?a ?l)))) (increase (total-cost) 1))
  )
)
