(define (problem p15)
  ...
  (:init
    ...
    (:utility
      (= (not (is-target p11)) 27)
      (= (not (is-target p15)) 29)
      (= (not (is-target p17)) 46)
      (= (not (is-target p18)) 48)
      (= (not (is-target p23)) 50)
      (= (not (is-target p24)) 41)
      (= (not (is-target p25)) 33)
      (= (not (is-target p26)) 6)
      (= (not (is-target p31)) 14)
      (= (not (is-target p33)) 34)
      (= (not (is-target p35)) 14)
      (= (not (is-target p36)) 4)
      (= (not (is-target p38)) 40)
      (= (not (is-target p39)) 43)
      (= (not (is-target p44)) 29)
      (= (not (is-target p45)) 31)
      (= (not (is-target p49)) 48)
      (= (not (is-target p53)) 23)
      (= (not (is-target p55)) 35)
      (= (not (is-target p56)) 27)
      (= (not (is-target p57)) 1)
      (= (not (is-target p58)) 14)
      (= (not (is-target p59)) 46)
  )
