(define (problem p13)
  ...
  (:init
    ...
    (:utility
      ...
      (= (not (is-target p12)) 24)
      (= (not (is-target p13)) 22)
      (= (not (is-target p14)) 38)
      (= (not (is-target p15)) 11)
      (= (not (is-target p25)) 19)
      (= (not (is-target p31)) 46)
      (= (not (is-target p33)) 3)
      (= (not (is-target p34)) 17)
      (= (not (is-target p35)) 4)
      (= (not (is-target p41)) 27)
      (= (not (is-target p43)) 8)
      (= (not (is-target p44)) 15)
      (= (not (is-target p45)) 38)
  )
