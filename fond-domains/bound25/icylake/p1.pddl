(define (problem icylake-p1)
  (:domain icylake)

  (:objects
    upperwall-0 - wall upperwall-1 - wall upperwall-2 - wall upperwall-3 - wall
    leftwall-3 - wall tile_0_3 - ice tile_1_3 - wall tile_2_3 - ice tile_3_3 - ice rightwall-3 - wall
    leftwall-2 - wall tile_0_2 - ice tile_1_2 - ice tile_2_2 - ice tile_3_2 - ice rightwall-2 - wall
    leftwall-1 - wall tile_0_1 - ice tile_1_1 - ice tile_2_1 - ice tile_3_1 - ice rightwall-1 - wall
    leftwall-0 - wall tile_0_0 - pit tile_1_0 - ice tile_2_0 - ice tile_3_0 - ice rightwall-0 - wall
  ...
  (:init
    (at tile_0_3)
    (reward-position first-aid-kit tile_3_3)
