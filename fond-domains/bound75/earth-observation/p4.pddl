(define (problem p04)
  ...
  (:init
    ...
    (:utility
      (= (not (is-target p11)) 33)
      (= (not (is-target p12)) 28)
      (= (not (is-target p13)) 29)
      (= (not (is-target p14)) 6)
      (= (not (is-target p21)) 46)
      (= (not (is-target p23)) 27)
      (= (not (is-target p24)) 41)
      (= (not (is-target p25)) 11)
      (= (not (is-target p26)) 28)
      (= (not (is-target p27)) 14)
      (= (not (is-target p31)) 47)
      (= (not (is-target p32)) 4)
      (= (not (is-target p33)) 21)
      (= (not (is-target p34)) 14)
      (= (not (is-target p35)) 4)
      (= (not (is-target p36)) 26)
  )
