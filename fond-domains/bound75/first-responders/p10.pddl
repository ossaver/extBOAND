(define (problem FR_1_10)
 ...
 (:init 
  ...
  (:utility
     (= (nfire l1) 8)
     (= (victim-status v1 healthy) 33)
     (= (victim-status v2 healthy) 9)
     (= (victim-status v3 healthy) 7)
     (= (victim-status v4 healthy) 6)
     (= (victim-status v5 healthy) 18)
     (= (victim-status v6 healthy) 28)
     (= (victim-status v7 healthy) 28)
     (= (victim-status v8 healthy) 30)
     (= (victim-status v9 healthy) 9)
     (= (victim-status v10 healthy) 25)
 )
