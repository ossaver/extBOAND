(define (problem icylake-p6)
  ...
  (:objects
    ...
    leftwall-3 - wall tile_0_3 - ice tile_1_3 - ice tile_2_3 - ice tile_3_3 - ice tile_4_3 - wall tile_5_3 - ice rightwall-3 - wall
    leftwall-2 - wall tile_0_2 - ice tile_1_2 - ice tile_2_2 - wall tile_3_2 - ice tile_4_2 - ice tile_5_2 - ice rightwall-2 - wall
    leftwall-1 - wall tile_0_1 - pit tile_1_1 - ice tile_2_1 - ice tile_3_1 - ice tile_4_1 - ice tile_5_1 - ice rightwall-1 - wall
    ...
    first-aid-kit-1 - reward first-aid-kit-2 - reward first-aid-kit-3 - reward diamond-1 - reward diamond-2 - reward
  )

  (:init
    (at tile_0_5)
    (reward-position first-aid-kit-1 tile_0_3)
    (reward-position first-aid-kit-2 tile_4_1)
    (reward-position first-aid-kit-3 tile_3_3)
    (reward-position diamond-1 tile_1_5)
    (reward-position diamond-2 tile_0_4)
