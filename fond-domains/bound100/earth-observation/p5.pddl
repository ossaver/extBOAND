(define (problem p05)
  ...
  (:init
    ...
    (:utility
      (= (not (is-target p12)) 46)
      (= (not (is-target p13)) 36)
      (= (not (is-target p14)) 11)
      (= (not (is-target p17)) 48)
      (= (not (is-target p25)) 34)
      (= (not (is-target p26)) 9)
      (= (not (is-target p31)) 34)
      (= (not (is-target p32)) 3)
      (= (not (is-target p33)) 14)
      (= (not (is-target p34)) 34)
      (= (not (is-target p35)) 2)
      (= (not (is-target p36)) 37)
      (= (not (is-target p37)) 41)
  )
