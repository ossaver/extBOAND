...
(:functions
  ...
  (:action pick-bad-gold-1
    ...
    :effect (and (oneof (and (not (goldcount-0)) (goldcount-1) (not (gold-bad-at ?loc)))
                   (not (person-alive))) (increase (total-cost) 1))
  )

  (:action pick-bad-gold-2
    :parameters (?loc - location)
    :precondition (and (person-at ?loc) (gold-bad-at ?loc) (person-alive) (goldcount-1))
    :effect (and (oneof (and (not (goldcount-1)) (goldcount-2) (not (gold-bad-at ?loc)))
                   (not (person-alive))) (increase (total-cost) 1))
  )
  ...
  (:action pick-bad-gold-3
    ...
    :effect (and (oneof (and (not (goldcount-2)) (goldcount-3) (not (gold-bad-at ?loc)))
                   (not (person-alive))) (increase (total-cost) 1))
  )
